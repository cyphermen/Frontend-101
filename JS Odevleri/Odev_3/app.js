...
const buttonList = () => {
  ...
  buttons.forEach((category) => {
    allButtons += `<button class="btn btn-outline-dark btn-item" data-id="${category}">${category}</button>`;
  });
  return allButtons;
};

buttonDOM.innerHTML = buttonList();
...
buttonDOM.addEventListener('click', (e) => {
  if (e.target.classList.contains('btn-item')) {
    ...
    displayMenuList(filteredMenu);
  }
});

const menuListContainer = document.querySelector(".section-center");
